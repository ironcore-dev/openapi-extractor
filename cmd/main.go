...
func main() {
	...
	flag.StringVar(&apiServerPath, "apiserver-bin-path", "", "Path to the aggregated apiserver binary")
	flag.StringSliceVar(&apiServicePaths, "apiservices-paths", []string{}, "Comma separated list of apiservice definitions")
	flag.StringVar(&outputDir, "output-dir", "", "Directory to store the extracted OpenAPI specs (default: current directory)")
